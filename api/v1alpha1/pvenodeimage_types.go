...
// PVENodeImageSpec defines the desired state of PVENodeImage
type PVENodeImageSpec struct {
	...
	// foo is an example field of PVENodeImage. Edit pvenodeimage_types.go to remove/update
	// +optional
...
type PVENodeImageStatus struct {
	...
	// conditions represent the current state of the PVENodeImage resource.
