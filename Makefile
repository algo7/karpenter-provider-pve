...
KIND_CLUSTER ?= karpenter-provider-pve-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name karpenter-provider-pve-builder
	$(CONTAINER_TOOL) buildx use karpenter-provider-pve-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm karpenter-provider-pve-builder
	rm Dockerfile.cross
